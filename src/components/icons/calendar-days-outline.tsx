...
interface CalendarDaysOutlineProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
}

function CalendarDaysOutline({
  className,
  ...props
}: CalendarDaysOutlineProps) {
  return (
    <svg
...
export default CalendarDaysOutline;
