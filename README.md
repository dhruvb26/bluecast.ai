...
- try to save the last processed id in the database
- reset database to 0 (need a cron for this)
- remove cron from vercel, add cron in trigger
- add creator's id in payload to the task
